...
`ctx.layout.toggleSidebar(true)` opens the sidebar idempotently for feature dialogs; `false` closes it, and an omitted argument toggles it. Opening preserves an already-expanded width.
