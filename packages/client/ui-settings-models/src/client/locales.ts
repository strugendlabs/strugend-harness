...
export const en = {
  ...
  intelligenceLocal: 'Local · bundled Laya, no key required',
  intelligenceLocalReady: 'Uses the bundled model. No API key required.',
  ...
  intelligenceDecisionHint: 'Bundled multilingual Laya evaluates short evidence in the background when memory permits. The optional Impossibl key is used only in Automatic or Remote mode.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  intelligenceLocal: '本地 · 内置 Laya，无需密钥',
  intelligenceLocalReady: '使用内置模型，无需 API 密钥。',
