...
export const en = {
  ...
  intelligenceIntro: 'One assistant, three complementary capabilities. Add keys here; never paste them into chat.',
  intelligenceCore: 'Core',
  intelligenceCoreHint: 'Planning, coding, writing, vision, and tool execution.',
  intelligenceDecision: 'Decision',
  intelligenceDecisionHint: 'Jev evaluates small, typed questions to help select skills, rank context, and check evidence.',
  intelligenceMemory: 'Memory',
  intelligenceMemoryHint: 'Read dated relationships from your Chronograph workspace. Automatic memory writing is not enabled.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  intelligenceDecision: 'Decision',
  intelligenceDecisionHint: 'Jev 评估简短的类型化问题，帮助选择技能、排列上下文和检查证据。',
  intelligenceMemory: 'Memory',
  intelligenceMemoryHint: '从 Chronograph 工作区读取带日期的关系。未启用自动记忆写入。',
  intelligenceGraphPlaceholder: 'http://127.0.0.1:8080',
