...
The desktop Automations panel creates, previews, edits, pauses and runs independent schedules. Recent run cards open their result tasks; polling stops when the panel closes. Settings → Updates exposes download checks and explicit installation preferences. The [Desktop reference](../../../apps/desktop/README.md#scheduled-tasks-and-updates) owns execution and release limits.
