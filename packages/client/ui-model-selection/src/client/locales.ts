...
export const zh = {
  ...
  'error.sessionInUse': '此聊天正在另一个应用实例中使用。请关闭另一个实例后重试。',
  'action.reload': '重新加载',
...
export const en = {
  ...
  'error.sessionInUse': 'This chat is in use by another application instance. Close that instance and try again.',
