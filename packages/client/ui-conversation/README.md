...
Strugend builds display the shared amber ribbon mark above a quiet empty-chat headline and a centered composer. Workspace, mode, access, and model controls retain their behavior; the right panel opens when a tool needs it.
