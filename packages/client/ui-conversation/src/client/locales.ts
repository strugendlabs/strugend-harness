...
export const zh = {
  ...
  'input.connectModel': '连接模型',
  'input.connectModelHint': '连接一个 AI 提供商以继续。你的草稿已保留。',
  'session.controls': '会话选项',
...
export const en = {
  ...
  'input.connectModel': 'Connect model',
  'input.connectModelHint': 'Connect an AI provider to continue. Your draft is saved.',
  'session.controls': 'Task options',
