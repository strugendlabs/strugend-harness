...
export const zh = {
  ...
  'chat.diagnostics': '诊断详情',
  'chat.hideDiagnostics': '隐藏诊断',
  'message.you': '你',
  'decision.observedOnly': '实验性审阅 · 仅记录',
  'decision.pending': '决策审阅中',
  'decision.suggestion': '审阅建议',
  'decision.inconclusive': '审阅无定论',
  'decision.unavailable': '审阅不可用',
  'decision.inconclusiveHint': '未得出可靠建议。主代理继续工作。',
  'decision.unavailableHint': '主代理继续工作，无需等待此审阅。',
  'decision.advisory': '仅供参考；不能代替测试或直接验证。',
  'decision.details': '详情',
  'decision.hideDetails': '隐藏详情',
  ...
  'stats.dialog.mainAgent': '主智能体',
  'stats.dialog.delegated': '委派智能体（{count}）',
  'stats.dialog.unavailable': '尚无用量记录',
  'stats.dialog.usageScope': '当前任务及可用子任务的已记录模型用量，包含重复的缓存输入。不含辅助模型调用、未报告用量的请求或其他任务；与服务商按 API 密钥统计的每日总量不同。',
  'stats.dialog.partialUsage': '部分统计：{count} 个委派任务暂无缓存用量，请打开其对话后刷新。',
  'stats.dialog.refreshing': '正在刷新任务用量…',
  'stats.dialog.refreshFailed': '无法刷新，正在显示最近可用的用量。关闭后重新打开可重试。',
...
export const en = {
  ...
  'chat.hideDiagnostics': 'Hide diagnostics',
  'message.you': 'You',
  'decision.observedOnly': 'Experimental review — recorded only',
  'decision.pending': 'Decision review running',
  'decision.suggestion': 'Review suggestion',
  'decision.inconclusive': 'Review inconclusive',
  'decision.unavailable': 'Review unavailable',
  'decision.inconclusiveHint': 'No reliable suggestion. The main agent continues.',
  'decision.unavailableHint': 'The main agent continues without waiting for this review.',
  'decision.advisory': 'Advisory only; tests and direct verification still apply.',
  'decision.details': 'Details',
  'decision.hideDetails': 'Hide details',
  ...
  'stats.dialog.mainAgent': 'Main agent',
  'stats.dialog.delegated': 'Delegated agents ({count})',
  'stats.dialog.unavailable': 'Not reported',
  'stats.dialog.usageScope': 'Recorded model usage for this task and available delegates, including repeated cached input. Excludes auxiliary calls, unreported usage and other tasks; this differs from the provider’s daily API-key total.',
  'stats.dialog.partialUsage': 'Partial total: {count} delegates have no cached usage. Open their conversations, then refresh.',
  'stats.dialog.refreshing': 'Refreshing task usage…',
  'stats.dialog.refreshFailed': 'Could not refresh. Showing the last available usage; close and reopen to retry.',
