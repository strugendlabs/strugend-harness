...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'async validateConnection(provider: string, model: string, signal?: AbortSignal): Promise<void>',
        description: 'Validate a selected route\'s local connection requirements before prompt admission. No model request or OAuth refresh occurs; dispatch still resolves current credentials.',
        parameters: [{ name: 'provider', description: 'Registered provider route.' }, { name: 'model', description: 'Exact selected model.' }, { name: 'signal', description: 'Cancellation for local credential checks.' }],
