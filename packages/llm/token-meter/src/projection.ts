...
/**
 * Durable cumulative provider usage for session-owned requests, excluding fork-inherited events.
 *
...
declare module '@deepseek-ai/dsh-session-projection/types' {
  interface SessionProjectionMap {
    /** Provider-reported usage accumulated across owned durable events, excluding inherited history. */
