...
LangString INSTALLER_LAUNCH_FAILED ${LANG_ENGLISH} "Strugend Harness could not be launched. Retry, or clear Launch now and close the installer."
LangString INSTALLER_LAUNCH_FAILED ${LANG_SIMPCHINESE} "无法启动 Strugend Harness。请重试，或取消勾选立即启动后关闭安装程序。"
...
LangString INSTALLER_RUNNING ${LANG_ENGLISH} "Strugend Harness is running. Close the application, then run this installer again."
LangString INSTALLER_RUNNING ${LANG_SIMPCHINESE} "Strugend Harness 正在运行。请先关闭应用，再重新运行安装程序。"
...
LangString INSTALLER_PATH_OWNERSHIP ${LANG_ENGLISH} "Choose an empty folder or the registered Strugend Harness installation folder."
LangString INSTALLER_PATH_OWNERSHIP ${LANG_SIMPCHINESE} "请选择空文件夹，或 Strugend Harness 原来的安装目录。"
